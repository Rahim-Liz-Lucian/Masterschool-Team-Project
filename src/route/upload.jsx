...
import { Input, BackButton, Button } from "~/component/core";
...
export default function Page() {
  ...
  const { onUpload, products, loading, error, resetError } = useHook({
    user,
    formData,
  });
    ...
    <>
      ...
      <main>
        ...
        <form className="form" id="upload" onSubmit={onUpload}>
          ...
          <Button
            classes="button primary form__submit"
            type="submit"
            form="upload"
          >
            Upload
...
const useHook = ({ user, formData }) => {
  const [products, productsError, productsLoading] = useFirebaseCollection(
    (store) => {
